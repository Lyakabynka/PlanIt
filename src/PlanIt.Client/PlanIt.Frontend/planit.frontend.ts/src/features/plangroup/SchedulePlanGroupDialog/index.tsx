...
interface SchedulePlanGroupDialogProps {
    planGroupId: string,
    open: boolean,
    setOpen: (params: boolean) => void,
}

export const SchedulePlanGroupDialog: React.FC<SchedulePlanGroupDialogProps> =
    ({ planGroupId, open, setOpen }) => {

        const { createScheduledPlanGroup } = usePlanGroupStore();
